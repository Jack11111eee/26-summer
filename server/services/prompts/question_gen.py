...
2. 难度档语义（SSOT §9.4 2026-09-09 锚点区间——易/中/难分别对应可观测等级
   区间的上限/下限，rubric 评分锚点受此约束）：
   - easy：概念理解与基本使用（对应 Lv2~Lv3，锚点区间 [2, 3]）
   - medium：独立完成常规工作（对应 Lv3~Lv4，锚点区间 [3, 4]）
   - hard：复杂问题处理/优化/权衡（对应 Lv4~Lv5，锚点区间 [4, 5]）
3. qtype 两档：
